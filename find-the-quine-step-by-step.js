...
var startVar = 0;
var newNodeIndex = 0;
var autoFilter = ['L','A','FI','FO','FOE','T','Arrow','GAMMA','DELTA'];
...
var transformListOrig = [
  {left:"GAMMA",right:"GAMMA",action:"remove2", named:"GAMMA-GAMMA"},
  {left:"DELTA",right:"DELTA",action:"remove3", named:"DELTA-DELTA"},
  {left:"GAMMA",right:"DELTA",action:"dist4", named:"GAMMA-DELTA", t1:"DELTA",t2:"DELTA",t3:"GAMMA",t4:"GAMMA"},
  {left:"L",right:"A",action:"remove", named:"L-A"},
  {left:"FI",right:"FOE",action:"remove", named:"FI-FOE"},
  {left:"L",right:"FO",action:"dist2", named:"L-FO", t1:"FOE",t2:"FI",t3:"L",t4:"L"},
  {left:"A",right:"FO",action:"dist1", named:"A-FO", t1:"FOE",t2:"FOE",t3:"A",t4:"A"}, // 3
  {left:"L",right:"FOE",action:"dist2", named:"L-FOE", t1:"FOE",t2:"FI",t3:"L",t4:"L"},
  {left:"A",right:"FOE",action:"dist1", named:"A-FOE", t1:"FOE",t2:"FOE",t3:"A",t4:"A"},
  {left:"FI",right:"FO",action:"dist1", named:"FI-FO", t1:"FO",t2:"FO",t3:"FI",t4:"FI"},
  {left:"FO",right:"FOE",action:"dist2", named:"FO-FOE", t1:"FOE",t2:"FI",t3:"FO",t4:"FO"}, // 4
  {left:"L",right:"T",action:"termsplit", named:"L-T"},
  ...
  for (var i=0; i<transformList.length; i++) {
    ...
    if (trans.left == n2type && trans.right == n1.type) {
      if (trans.action == "term1") {
        ...
        if (trans.action == "remove" || trans.action == "dist1" || trans.action == "dist2" || trans.action == "term") {
          if (e2.type == "right") return trans;
        } else if (trans.action == "remove2" || trans.action == "remove3" || trans.action == "dist4" || trans.action == "term3" || trans.action == "remove4") {
          if (e2.type == "left")  return trans;
        }
      }
      return null;
...
function doTransform(n1, trans) {
  ...
  switch (trans.action) {
    ...
    case "remove2":
      ...
      // Link right n1 to out n2 and out n1 to right n2
      moveLink2(d,b);
      moveLink2(c,b1);
    ...
    case "remove3":
      ...
      // Link right n1 to right n2 and out n1 to out n2
      moveLink2(d,b1);
      moveLink2(b,c);
